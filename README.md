...
- [Death to the Batch Job](https://particular.net/blog/death-to-the-batch-job)
- [Putting your Events on a Diet](https://particular.net/blog/putting-your-events-on-a-diet)
- [Pitfalls of Request/Response Over Messaging, Mauro Servienti](https://milestone.topics.it/2023/01/19/pitfalls-of-request-response-over-messaging.html)
